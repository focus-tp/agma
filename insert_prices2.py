...
# Replace the old services block: <section class="services section-light" id="services"> ... </section>
# It ends right before <section class="contact section-light" id="contact">
import re
match = re.search(r'\s*<section class="services section-light" id="services">.*?(?=<section class="contact section-light" id="contact">)', html, re.DOTALL)
if match:
